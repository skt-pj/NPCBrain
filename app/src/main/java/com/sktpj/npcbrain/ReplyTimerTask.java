...
final class ReplyTimerTask {
    ...
    static ReplyTimerTask fromJson(JSONObject json) {
        ...
        ReplyTimerTask task = new ReplyTimerTask(
                json.optString("source_key", ""),
                json.optInt("job_id", 0),
                json.optString("mode", ""),
                json.optString("npc_id", ""),
                json.optString("room_id", ""),
                json.optString("source_message_id", ""),
                json.optString("source_event_id", ""),
                json.optJSONObject("source_message"),
                json.optJSONObject("source_event"),
                json.optLong("wake_at_ms", 0L),
