        ...
        try {
            ...
            tool.put("description",
                    "Global Workspace MUST emit exactly one structured runtime decision before its final JSON response. "
                            ...
                            + "There is no universal prerequisite checklist for participation. Do not require date, place, contents, danger level, withdrawal route, or any other common information set before deciding. Missing information matters only when this character's own personality, current state, memory, relationships and grounded context make it matter. "
